model schwinger
  ...
  Modelica.Mechanics.Translational.Components.SpringDamper springDamper1(c = 1, d = 0.1) annotation(
...
equation
  ...
  connect(springDamper1.flange_b, mass1.flange_a) annotation(
    Line(points = {{66, 0}, {76, 0}}, color = {0, 127, 0}));
  connect(mass.flange_b, springDamper1.flange_a) annotation(
    Line(points = {{40, 0}, {46, 0}}, color = {0, 127, 0}));
  annotation(
